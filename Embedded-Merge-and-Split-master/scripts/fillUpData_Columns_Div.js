...
function startTheProject() {
    ...
    .attr('xlink:href', 'https://cdn.dribbble.com/users/1925451/screenshots/4747967/platforms.jpg')
    .attr('width', "112%")
    .attr('height', "171%")
    ...
    let rect = mainSVG.append("rect")
        ...
        .attr("width", "300px")
        .attr("height", "180px")
        .attr("transform", `translate(${window.innerWidth/2 - 150}, ${window.innerHeight/2 - 100})`)
        .style("cursor", "pointer")
        .style("opacity", 1)
    
    mainSVG.append("text")
        .text("Embedded Merge & Split")
        .attr("fill", "white")
        .attr("transform", `translate(${window.innerWidth/2-20}, ${window.innerHeight/2-350})`)
        .attr("text-anchor", "middle")
        .style("font-size", "50")

    mainSVG.append("text")
        .text("Visual Adjustment of Data Grouping")
        .attr("fill", "white")
        .attr("transform", `translate(${window.innerWidth/2-20}, ${window.innerHeight/2-280})`)
        .attr("text-anchor", "middle")
        .style("font-size", "50")
...
//    .attr('height', "123%")
    ...
    let rect = svg.append("rect")
        ...
        .attr("width", "400px")
        .attr("height", "200px")
        .attr("transform", `translate(${window.innerWidth/2-200}, ${window.innerHeight/2 - 100})`)
        .style("cursor", "pointer")
        .style("opacity", 1)
